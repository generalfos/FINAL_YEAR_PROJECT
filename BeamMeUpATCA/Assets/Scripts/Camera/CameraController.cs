...
namespace BeamMeUpATCA
{
    public class CameraController : MonoBehaviour
    {
        ...
        public void FocusCameraFree(Vector2 focusPosition)
        {
            // Offsets positioning camera for fairly tight view of target
            int yOffset = 30;
            int zOffset = -20;

            GameObject selectedObject = Selector.SelectGameObject(ActiveCamera, focusPosition, new List<string>() { "Unit", "Array", "Building" });
            Debug.Log("FocusFree called");
